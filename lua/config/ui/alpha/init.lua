...
local buttons = {
  ...
  val = {
    ...
    dashboard.button("m", "  Mason Tools", ":Mason<CR>"),
...
local header = {
  ...
  val = require("config.ui.alpha.headers").banners.ansi_shadow,
  opts = {
    position = "center",
    hl = "AlphaHeader",
  },
...
layout[3] = section_mru
layout[4] = { type = "padding", val = 2 }
layout[5] = buttons
layout[6] = { type = "padding", val = 2 }
layout[7] = footer
