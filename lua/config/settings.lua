...
-- copilot node command is the full path to the
-- node binary used.  As of now it requires the 16.x release
M.copilot_node_command = "/Users/nhudson/Downloads/node-v16.16.0/bin/node"
